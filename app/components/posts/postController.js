...
var postController = function ($scope, postFactory, userFactory, $routeParams, $location, $filter) {
...
app.controller('postController', ['$scope', 'postFactory', 'userFactory', '$routeParams', '$location','$filter', postController]);
